...
export const MESSAGE_TYPES = {
  ...
  DELETE_CONNECTED_SITE: 'DELETE_CONNECTED_SITE',
  DELETE_ALL_CONNECTED_SITES: 'DELETE_ALL_CONNECTED_SITES',
  // EVM Signing
  ...
  EVM_SIGN_TRANSACTION: 'EVM_SIGN_TRANSACTION',
  // EVM Transactions
  ...
  EVM_GET_GAS_PRICE: 'EVM_GET_GAS_PRICE',
  EVM_GET_TRANSACTION_BY_HASH: 'EVM_GET_TRANSACTION_BY_HASH',
  EVM_GET_TRANSACTION_RECEIPT: 'EVM_GET_TRANSACTION_RECEIPT',
  // Hyperliquid DEX
...
export const SIGNING_ERRORS = {
  ...
  PRIVATE_KEY_ACCESS_FAILED: {
    code: 4001,
    message:
      'Failed to access private key. Please ensure your wallet is unlocked.',
    retryable: true,
  },
  INVALID_PRIVATE_KEY: {
    code: 4001,
  ...
  EIP712_SIGNING_FAILED: {
    code: 4001,
    message:
      'EIP-712 typed data signing failed. Please check the message format.',
    retryable: true,
  },
  USER_REJECTED: {
    code: 4001,
  ...
  SESSION_STORAGE_UNAVAILABLE: {
    code: 4001,
    message:
      'Secure session storage unavailable. Please restart the extension.',
    retryable: true,
  },
  OFFSCREEN_TIMEOUT: {
    code: 4001,

...
export const runTest = async (testName: string, testFn: () => Promise<void>) => {
    try {
        await testFn();
...
export const TEST_PRIVATE_KEY = '0x1234567890123456789012345678901234567890123456789012345678901234';

...
const mergeWithDefaults = (stored: any) => {
    ...
    return {
        ...
        activeNetworks: Object.keys(mergedNetworks).filter(key =>
            mergedNetworks[key as ChainTypeClient].isActive
        ) as ChainTypeClient[],
    ...
    persist(
        (set, get) => ({
            ...
            toggleNetwork: (networkId: ChainTypeClient) => {
                ...
                set((state) => {
                    ...
                    const newActiveNetworks = (Object.values(newNetworks) as NetworkConfig[])
        ...
        }),
        {
            ...
            migrate: (persistedState: any, version: number) => {
                console.log('🔄 Migrating network settings from version', version, 'to 3');

...
export type ImportType = 'seed' | 'privateKey' | 'create-account' | 'watchOnly' | null;
...
const createWalletStore = create<CreateWalletState & CreateWalletActions>((set) => ({
    mnemonic: undefined,
    password: undefined,
    ...
    setSelectedSeedPhraseId: (seedPhraseId) => set({ selectedSeedPhraseId: seedPhraseId }),
